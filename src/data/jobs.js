module.exports = [
  {
    ...
    description:
      "Helped clients to implement DevOps practices and tools from IBM and from the open source community into their software development cycles." +
      "Participated in the IBM Summit Training before being put on a zDevOps Team."
  },
  {
    id: 2,
    company: "IBM",
